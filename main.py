...
window.title("Vasavi Public School")
...
head_checkbox = tk.Radiobutton(window,text = "Principal",variable = radio,value = 1,width = 10,
                                  font=("Vishwanatham",12,"bold"),bg = '#897C78',fg = '#18120F',activebackground = '#897C78')
head_checkbox.place(x = 40,y = 160)

teacher_checkbox = tk.Radiobutton(window,text = "Teacher",variable = radio,value = 2,width = 10,
                                  font=("Krishnaveni",12,"bold"),bg = '#897C78',fg = '#18120F',activebackground = '#897C78')
...
def logincommand(name_enter,password_enter):
        ...
        if(radio.get()==3):
            ...
            if(password_enter==cur.fetchone()[0]):
                ...
                newwindow.title("Vasavi Public School")
        ...
        if(radio.get()==2):
            ...
            if(password_enter==cur.fetchone()[0]):
                ...
                def addnew():
                    ...
                    newwindow6.title("Vasavi Public School")
        ...
        if(radio.get()==1):
            ...
            if(password_enter==cur.fetchone()[0]):
                ...
                newwindow2.title("Vasavi Public School")
                ...
                def eedit1():
                    ...
                    newwindow4.title("Vasavi Public School")
                ...
                def eedit2():
                    ...
                    newwindow5.title("Vasavi Public School")
